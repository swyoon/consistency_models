...
##### sampling from EDM model
## HEUN sampler
# export OPENAI_LOGDIR="imagenet64_edm_heun"
# mpiexec -n 4 python image_sample.py --training_mode edm --batch_size 64 --sigma_max 80 --sigma_min 0.002 --s_churn 0 --steps 40 --sampler heun  \
#     --model_path ../pretrained/edm_imagenet64_ema.pt --attention_resolutions 32,16,8  --class_cond True --dropout 0.1 --image_size 64 --num_channels 192 \
#     --num_head_channels 64 --num_res_blocks 3 --num_samples 50000 --resblock_updown True --use_fp16 True --use_scale_shift_norm True --weight_schedule karras

export OPENAI_LOGDIR="imagenet64_edm_ancestral"
mpiexec -n 4 python image_sample.py --training_mode edm --batch_size 64 --sigma_max 80 --sigma_min 0.002 --s_churn 0 --steps 40 --sampler ancestral  \
    --model_path ../pretrained/edm_imagenet64_ema.pt --attention_resolutions 32,16,8  --class_cond True --dropout 0.1 --image_size 64 --num_channels 192 \
    --num_head_channels 64 --num_res_blocks 3 --num_samples 50000 --resblock_updown True --use_fp16 True --use_scale_shift_norm True --weight_schedule karras



# OPENAI_LOGDIR=cd_imagenet64_lpips_test mpiexec -n 4 python image_sample.py --batch_size 256 --training_mode consistency_distillation --sampler onestep --model_path ../pretrained/cd_imagenet64_lpips.pt --attention_resolutions 32,16,8 --class_cond True --use_scale_shift_norm True --dropout 0.0 --image_size 64 --num_channels 192 --num_head_channels 64 --num_res_blocks 3 --num_samples 50000 --resblock_updown True --use_fp16 True --weight_schedule uniform
...
# export OPENAI_LOGDIR="imagenet64_cd_lpips"
# mpiexec -n 4 python cm_train.py --training_mode consistency_distillation --target_ema_mode fixed --start_ema 0.95 --scale_mode fixed \
#      --start_scales 40 --total_training_steps 600000 --loss_norm lpips --lr_anneal_steps 0 --teacher_model_path ../pretrained/edm_imagenet64_ema.pt \
...
#     --use_fp16 True --weight_decay 0.0 --weight_schedule uniform --data_dir /opt/home3/swyoon/imagenet/ILSVRC/Data/CLS-LOC/train
